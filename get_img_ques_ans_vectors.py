...
def get_vector_for_image(img_path):
    '''
        input: image path
    ...
    image = None
    if "COCO" in img_path:
        image = load_img(r"..\\vqa_react\\public\\complex_images\\"+img_path, target_size=(224, 224))
    else:    
...
def get_timeseries_vector_ques(question_string):
    '''
    ...
    len_of_timeseries = 25 # maximum length of question - arbirtarly chosen number since the maximum length was 25
